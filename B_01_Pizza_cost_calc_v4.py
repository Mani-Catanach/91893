...
def get_expenses(exp_type, how_many=10):
    ...
    if exp_type == "utility":
        ...
        while True:
            ...
            if price_for_one <= 23.50:
                ...
                print("You cannot have an employee work 0 hours. Make a new employee type")
                print()
                continue
    ...
    util_frame['UCost'] = util_frame['Utility Cost']
    ...
    utility_string = tabulate(util_frame[['UCost']], headers='keys',
                                  tablefmt='psql', showindex=False)

    # return the expenses panda and subtotal
    return expense_string, subtotal, utility_string
...
pizza_panda_string = pi_profit_string[0]
...
min_amount_string = f"Minimum Amount: {min_num}"
max_amount_string = f"Maximum Amount: {max_num}"
avg_amount_string = f"Average Amount: {avg_num}"
suggest_amount_string = make_statement(f"Suggested Amount:"
                                       f"${avg_num}", "*")
...
to_write = [main_heading_string,
            ...
            pizza_panda_string,
            avg_amount_heading, total_expenses_string,
            min_amount_string, max_amount_string,
