...
suggest_amount = round_up(avg_amount, round_to)
...
min_amount_string = f"Minimum Amount: {min_amount:.2f}"
max_amount_string = f"Maximum Amount: {max_amount:.2f}"
avg_amount_string = f"Average Amount: {avg_amount:.2f}"
